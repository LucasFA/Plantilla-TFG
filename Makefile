...
SOURCES += $(shell find . -wholename './capitulos/*.md' | sort | awk -F'\0' '{print $2}')
...
PANDOC_FLAGS_PDF = --template ./tfg.tex
# disponible en https://github.com/latex-mat-ugr/Plantilla-TFG/ 
PANDOC_FLAGS_WEB =\
	--standalone \
	--toc \
	--toc-depth 4 \
